...
public class RecipeController {
    ...
    public Recipe grilledCheese() {
        ...
        steps.add(new RecipeStep(3, "Put half of butter in the skillet.", ""));
        ...
        steps.add(new RecipeStep(6, "When underside is golden brown (after about 4 minutes) turn sandwich and add remaining butter to skillet.", ""));
